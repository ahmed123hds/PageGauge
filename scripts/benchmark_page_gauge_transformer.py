...
VALUE_CONDITIONING = load_local_module(
    "page_gauge_value_conditioning", ROOT / "scripts/page_gauge_value_conditioning.py"
)
...
class TransformerDecoder:
    def __init__(
        ...
        self.value_conditioning = None
        if backend == "page_gauge":
            self.value_conditioning = VALUE_CONDITIONING.fold_packed_weights(model, cache)
