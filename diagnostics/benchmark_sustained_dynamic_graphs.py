...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    # Optional conditioning metadata is created while the HF prefixes are populated.
    cache_manifest = BACKEND.cache_tensor_manifest(cache, args.backend)
    ...
    config = {
        ...
        "tail_attention": args.tail_attention,
        "old_value_scale_placement": args.old_value_scale_placement,
        "value_conditioning_mode": (decoder.value_conditioning or {}).get("mode", "none"),
        "trajectory_mode": args.trajectory_mode,
    ...
    source_paths = (
        ...
        ROOT / "scripts/page_gauge_value_conditioning.py",
    ...
    return {
        ...
        "backend": args.backend,
        "cuda_graph_scope": DYNAMIC_GRAPH_SCOPE,
        "value_conditioning": decoder.value_conditioning,
