...
def collect(out):
    ...
    extension = Path('/home/anonymous/pagegauge_baselines/kivi_sm120_env/lib/python3.12/site-packages/kivi_gemv.cpython-312-x86_64-linux-gnu.so')
    sources[str(extension)] = sha(extension)
