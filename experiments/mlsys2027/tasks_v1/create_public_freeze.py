...
SOURCES = {
    ...
    'qwen_pg': ('synthetic_20260909T025247Z_a44bf775', '/home/anonymous/page_gauge_env_protocol_v2/bin/python'),
    ...
    'qwen_kitty': ('kitty_kitty_pro_cohort_20260910T094135Z_2ebcd357', '/home/anonymous/pagegauge_baselines/kitty_sm120_env/bin/python'),
}
...
def collect(out):
    ...
    for group, (name, python) in SOURCES.items():
        ...
        if family not in models:
            ...
            models[family] = {'path': manifest['model'], 'input_file_evidence': evidence,
                              'context_limit': 32768, 'eos_ids': [151645] if family == 'qwen3' else [2]}
    ...
    result = {'status': 'candidate_not_authorized_for_data',
        ...
        'remaining': ['Full saved-file loader/scorer integration test',
                      'Qwen current task worker qualification/source coverage audit',
                      'Review candidate then write distinct final pre-exposure freeze']}
