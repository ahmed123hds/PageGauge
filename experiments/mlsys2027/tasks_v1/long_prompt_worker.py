...
No built-in data loading or answer scoring. Short prompts fail explicitly.
"""
import argparse
...
def worker(out):
    ...
    for index, case in enumerate(cases):
        ...
        if contract.fp16_fallback:
            raise ValueError('Short-prompt fallback not implemented in this long-prompt worker; no silent policy change')
